...
global.email = "roysparks42@gmail.com";
...
global.owner = process.env.OWNER_NUMBER || "ROY";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "Roy-made-this",
  ...
  LANG: (process.env.THEME || " MY BOT ").toUpperCase(),
};
global.rank = "updated";
